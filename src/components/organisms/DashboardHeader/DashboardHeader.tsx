            ...
            {showCompanyDropdown && (
              ...
              >
                ...
                <button 
                  ...
                  tabIndex={0}
                >
                  <img src="/images/page2/user.png" alt="Manage Users" className="h-5 w-5 mr-3" />
                  Manage Users
                </button>
                ...
                <button 
                  ...
                  tabIndex={0}
                >
                  <img src="/images/page2/mails.png" alt="Contact Us" className="h-5 w-5 mr-3" />
                  Contact Us
                </button>
                ...
                <button 
                  ...
                  tabIndex={0}
                >
                  <img src="/images/page2/logouts.png" alt="Logout" className="h-5 w-5 mr-3" />
                  Logout
                </button>
              </div>
            )}
